        ...
        <footer style={{backgroundColor: "rgb(240, 240, 240)"}} >
            ...
            <div className="row mt-5">
                <div className="col">
                    ...
                    <p> &copy; 2010 - 2024, Not zeorodha Broking Ltd. All rights reserved</p>
                </div>
                <div className="col">
                    <p>Company</p>
                    <a href="#" >About</a> <br />
