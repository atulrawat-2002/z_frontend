        ...
        <div className="container mt-5 ">
            <div className="row">
                ...
                <div className="col-6">
                    ...
                    <p>Varsity, the largest online stock market education book in the world covering everything from the basics to advanced trading.</p> <a href="#">Varsity→ </a>
